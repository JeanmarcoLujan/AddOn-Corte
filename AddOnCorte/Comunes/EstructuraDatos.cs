    ...
    class EstructuraDatos
    {
        ...
        private void CrearUDFAddOn()
        {
            try
            {
                ...
                CreaCampoMD("@MGS_CL_COCABE", "MGS_CL_RTNBO", "Total nro de bobinas", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 20, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                CreaCampoMD("@MGS_CL_COCABE", "MGS_CL_RTCAN", "Total cantidad", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 20, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                CreaCampoMD("@MGS_CL_COCABE", "MGS_CL_RTBOA", "Total bobinas en almacen", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 20, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                CreaCampoMD("@MGS_CL_COCABE", "MGS_CL_RTBOV", "Total bobinas para venta", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 20, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                CreaCampoMD("@MGS_CL_COCABE", "MGS_CL_RTCAV", "Total cantidad para venta", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 20, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                CreaCampoMD("@MGS_CL_COCABE", "MGS_CL_MTANC", "Total ancho master", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 20, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                CreaCampoMD("@MGS_CL_COCABE", "MGS_CL_MTLAR", "Total largo master", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 20, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                CreaCampoMD("@MGS_CL_COCABE", "MGS_CL_MTCANT", "Total cantidad master", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 20, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                CreaCampoMD("@MGS_CL_COCABE", "MGS_CL_OFEV", "Referencia oferta venta", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 20, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                CreaCampoMD("@MGS_CL_COCABE", "MGS_CL_AFECOR", "Agenda fecha de corte", SAPbobsCOM.BoFieldTypes.db_Date, SAPbobsCOM.BoFldSubTypes.st_None, 20, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                ...
                CreaCampoMD("@MGS_CL_COCABE", "MGS_CL_SOLTRA", "Ref solicitud traslado", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 30, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                CreaCampoMD("@MGS_CL_COCABE", "MGS_CL_RESFILE", "Aplica resfile", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 2, SAPbobsCOM.BoYesNoEnum.tNO, new string[] { "Y", "N" }, new string[] { "SI", "NO" }, "N", null);
                ...
                CreaCampoMD("@MGS_CL_COMAST", "MGS_CL_ALMC", "Almacén", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 40, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                ...
                CreaCampoMD("@MGS_CL_RCOCABE", "MGS_CL_REFSAC", "Ref salida core", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 20, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                CreaCampoMD("@MGS_CL_RCOCABE", "MGS_CL_REFETG", "Ref entrega ventas", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 20, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                CreaCampoMD("@MGS_CL_RCOCABE", "MGS_CL_REFSTR", "Ref solicitud tras. rec.", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 20, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                ...
                CreaCampoMD("@MGS_CL_RCOCABE", "MGS_CL_PRO4", "Proceso 4", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 2, SAPbobsCOM.BoYesNoEnum.tNO, new string[] { "Y", "N" }, new string[] { "SI", "NO" }, "N", null);
                CreaCampoMD("@MGS_CL_RCOCABE", "MGS_CL_PRO5", "Proceso 5", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 2, SAPbobsCOM.BoYesNoEnum.tNO, new string[] { "Y", "N" }, new string[] { "SI", "NO" }, "N", null);
                CreaCampoMD("@MGS_CL_RCOCABE", "MGS_CL_PRO6", "Proceso 6", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 2, SAPbobsCOM.BoYesNoEnum.tNO, new string[] { "Y", "N" }, new string[] { "SI", "NO" }, "N", null);
                CreaCampoMD("@MGS_CL_RCOCABE", "MGS_CL_PRO7", "Proceso 7", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 2, SAPbobsCOM.BoYesNoEnum.tNO, new string[] { "Y", "N" }, new string[] { "SI", "NO" }, "N", null);
                ...
                CreaCampoMD("@MGS_CL_RCOCABE", "MGS_CL_MBOIZQ", "Maste borde izquierdo", SAPbobsCOM.BoFieldTypes.db_Float, SAPbobsCOM.BoFldSubTypes.st_Quantity, 30, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                CreaCampoMD("@MGS_CL_RCOCABE", "MGS_CL_MCENTR", "Maste centro", SAPbobsCOM.BoFieldTypes.db_Float, SAPbobsCOM.BoFldSubTypes.st_Quantity, 30, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                CreaCampoMD("@MGS_CL_RCOCABE", "MGS_CL_MBODER", "Maste borde derecho", SAPbobsCOM.BoFieldTypes.db_Float, SAPbobsCOM.BoFldSubTypes.st_Quantity, 30, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                CreaCampoMD("@MGS_CL_RCOCABE", "MGS_CL_BBOIZQ", "Bobinas borde izquierdo", SAPbobsCOM.BoFieldTypes.db_Float, SAPbobsCOM.BoFldSubTypes.st_Quantity, 30, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                CreaCampoMD("@MGS_CL_RCOCABE", "MGS_CL_BCENTR", "Bobinas centro", SAPbobsCOM.BoFieldTypes.db_Float, SAPbobsCOM.BoFldSubTypes.st_Quantity, 30, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                CreaCampoMD("@MGS_CL_RCOCABE", "MGS_CL_BBODER", "Bobinas borde derecho", SAPbobsCOM.BoFieldTypes.db_Float, SAPbobsCOM.BoFldSubTypes.st_Quantity, 30, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                CreaCampoMD("@MGS_CL_RCOCABE", "MGS_CL_ENHEBR", "Enhebrado", SAPbobsCOM.BoFieldTypes.db_Float, SAPbobsCOM.BoFldSubTypes.st_Quantity, 30, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
                CreaCampoMD("@MGS_CL_RCOCABE", "MGS_CL_REBOBI", "Rebobinar", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 2, SAPbobsCOM.BoYesNoEnum.tNO, new string[] { "Y", "N" }, new string[] { "SI", "NO" }, "N", null);
                ...
                CreaCampoMD("@MGS_CL_RCOMAST", "MGS_CL_ALMC", "Almacén", SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, 40, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null, "");
